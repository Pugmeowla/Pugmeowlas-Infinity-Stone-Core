kill @e[type=minecraft:armor_stand,tag=temp_stand]
summon armor_stand ~ ~ ~ {Tags:["temp_stand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"infinity:portal",Count:1b}]}
