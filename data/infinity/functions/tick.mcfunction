execute as @e[tag=blackhole] at @s run particle minecraft:end_rod ~ ~ ~ 0 0 0 0.5 1 force
execute as @e[tag=blackhole] at @s run particle minecraft:squid_ink ~ ~ ~ 0.1 0 0.1 0.001 5 force
execute as @s run execute at @s run particle dust 1 1 1 10 ^ ^2 ^5 0.3 0.3 0.3 0 50
